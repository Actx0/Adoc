---
title: "Quickstart"
description: "Create a workspace, pick a plan, and run the memory, knowledge, and prompt loop with the Actx0 clients."
icon: "zap"
---

## Quickstart

Get from a new account to saved messages, retrieved memories, indexed knowledge, and a versioned prompt.

You will use the [dashboard](https://app.actx0.com) for workspace, billing, and access keys, then one of [Pctx0](https://github.com/Actx0/Pctx0) (Python), [Nctx0](https://github.com/Actx0/Nctx0) (Node.js), [Gtcx0](https://github.com/Actx0/Gctx0) (Go), **cURL**, or [Acli](https://github.com/Actx0/Acli).
...
<Steps>
  ...
  <Step title="Install a client">
    <Tabs>
      <Tab title="Python">
        [Pctx0](https://github.com/Actx0/Pctx0)
      ...
      <Tab title="Node.js">
        [Nctx0](https://github.com/Actx0/Nctx0)
      ...
      <Tab title="Go">
        [Gtcx0](https://github.com/Actx0/Gctx0)
      ...
      <Tab title="cURL">
        REST base URL: `https://app.actx0.com/api/v1`
      ...
      <Tab title="Acli">
        [Acli](https://github.com/Actx0/Acli)
...
<CardGroup cols={2}>
  <Card title="Platform overview" icon="cloud" href="/actx0-platform/overview">
