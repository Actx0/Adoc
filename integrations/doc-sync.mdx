...
<Steps>
  ...
  <Step title="Add a workflow">
    A complete sample lives in [Actx0/doc-sync-example](https://github.com/Actx0/doc-sync-example).
...
The same binary ships as a CLI. Release archives are published when a `v*` tag is pushed on [Actx0/doc-sync](https://github.com/Actx0/doc-sync). Pin that exact tag in `uses:` (currently [`v1.0.0`](https://github.com/Actx0/doc-sync/releases/tag/v1.0.0)).
