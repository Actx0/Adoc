...
<Info>
  Agent plugins are **in progress**. This page is a placeholder for upcoming docs. Check back as we ship each plugin.
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="More editors" icon="puzzle-piece">
...
- Wire [MCP](/release-notes/sdk_tools) manually with a workspace access key
